...
async function getStartManifest() {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-CV767xZD.js");
...
const manifest = { "c734b57656130e92f97e5895851097dba28c0c97bd955c5a94d61db533974b39": {
  functionName: "loginFn_createServerFn_handler",
  importer: () => import("./assets/_authed-BcE5fRzM.js")
...
function createStartHandler(cb) {
  ...
  const getEntries = async () => {
    if (routerEntry === null) {
      routerEntry = await import("./assets/router-DBOkoIrA.js").then((n) => n.r);
    }
    if (startEntry === null) {
